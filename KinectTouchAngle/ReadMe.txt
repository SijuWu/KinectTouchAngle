========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet KinectTouchAngle
========================================================================

AppWizard a créé cette application KinectTouchAngle pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application KinectTouchAngle.


KinectTouchAngle.vcxproj
...
KinectTouchAngle.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé KinectTouchAngle.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
